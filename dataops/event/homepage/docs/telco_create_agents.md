...
**Basic Information:**
- **Name**: `CUBIC_CONNECTED_VEHICLE_AGENT`
- **Description**: `Cubic³ agent for SDV connectivity ops and driver experience; combines semantic models and search for comprehensive analysis`
...
- **Warehouse**: Select `TELCO_DEMO_WH`
- **Timeout**: `60` seconds
...
1. `CALL_TRANSCRIPT_SEARCH` - Semantic search across driver support transcripts
...
- "Which regions have the highest attach failure or latency for OEM Program A?"

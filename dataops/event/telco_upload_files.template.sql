-- ============================================================================
-- Cubic³ Connected Vehicle AI Demo - Upload Files to Stages (DataOps Template)
-- ============================================================================
...
-- Upload all Cubic³ demo CSV data files (dimensions, facts, salesforce tables)
...
PUT 'file://{{ env.CI_PROJECT_DIR }}/dataops/event/DATA/demo_data/cubic_kpi.csv' @DATA_STAGE/demo_data/ AUTO_COMPRESS=FALSE OVERWRITE=TRUE;
...
-- ============================================================================
-- Step 2: Upload Cubic³ Unstructured Documents to DATA_STAGE/unstructured_docs/
-- Uses Cubic³-branded markdown placeholders; replace/add PDFs with Cubic³ investor/press/product docs as needed.
-- ============================================================================

-- Upload Cubic³ finance/strategy/network/sales/marketing/HR docs (markdown, legacy filenames)
...
-- Finance & investor materials (optional - replace with Cubic³ PDFs if available)
-- Example: PUT 'file://{{ env.CI_PROJECT_DIR }}/reports/CUBIC3_INVESTOR_PLACEHOLDER.pdf' @DATA_STAGE/unstructured_docs/finance/ AUTO_COMPRESS=FALSE OVERWRITE=TRUE;
-- Example: PUT 'file://{{ env.CI_PROJECT_DIR }}/reports/CUBIC3_ESG_PLACEHOLDER.pdf' @DATA_STAGE/unstructured_docs/strategy/ AUTO_COMPRESS=FALSE OVERWRITE=TRUE;

...
1. **Display Name**: Enter a user-friendly name for your Intelligence interface (e.g., "Cubic³ Intelligence" or your organization name)
...
- Keep it clear and brand-focused (e.g., "Cubic³ Connected Vehicle Agent")
...
2. Find your **"CUBIC_CONNECTED_VEHICLE_AGENT"** (or your chosen display name)
...
GRANT USAGE ON AGENT SNOWFLAKE_INTELLIGENCE.AGENTS."CUBIC_CONNECTED_VEHICLE_AGENT" 
...
GRANT USAGE ON WAREHOUSE TELCO_DEMO_WH TO ROLE TELCO_ANALYST_ROLE;
```
...
4. Select your **CUBIC_CONNECTED_VEHICLE_AGENT** from the agent dropdown
...
- "Which regions have the highest attach failure for OEM Program A?"
- "Show me markets where roaming latency exceeds 120ms for infotainment traffic."
- "What is the packet loss trend by country for in-car streaming?"
- "Which infrastructure components need capacity upgrades this quarter?"

**Driver Experience Questions:**
- "What are the top 3 driver complaints this month?"
- "Find support tickets about streaming/infotainment buffering."
- "Which OEM programs have the highest churn risk?"
- "Show me drivers with CSAT score below 3 after the latest OTA."

**Search-Based Questions (Unstructured Data):**
- "Find calls mentioning eSIM activation or VoLTE/VoNR issues."
- "Show me transcripts where drivers mention specific MNO partners."
- "What support tickets are about roaming charges or data caps?"
- "Find complaints about in-car video/StreamLocal³ coverage."

**Combined Intelligence Questions:**
- "Are roaming issues correlated with negative driver sentiment?"
- "Show me regions with both high latency and support tickets after the OTA release."
- "What percentage of calls mention specific MNO partners?"
- "Which regions show both packet loss spikes and increased support volume?"
...
**You:** *"Which OEM programs have the highest churn risk?"*  
**Agent:** *Analyzes the `customer_360_view` and returns a breakdown showing which models and countries are most at risk.*

**You:** *"What are the common complaints from those programs?"*  
**Agent:** *Searches `CALL_TRANSCRIPT_SEARCH` and identifies roaming, eSIM activation, and infotainment buffering as top themes.*

**You:** *"Show me the revenue impact of at-risk programs."*  
**Agent:** *Queries structured data again to calculate total monthly revenue at risk and ARPU impact.*

**You:** *"What specific network issues are they mentioning?"*  
**Agent:** *Returns top themes: attach failures, VoLTE/VoNR setup issues, high latency during streaming.*
